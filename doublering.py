...
for i in range(const.N):
 if(i==0):
   ...
   print("east_in"+str(i+(const.N-1))+"<="+"west_out"+str(i)+";")
 if(i==const.N-1):
   print("west_in"+str(i-(const.N-1))+"<="+"east_out"+str(i)+";")
   print("east_in"+str(i-1)+"<="+"west_out"+str(i)+";")
 if(i!=0 and i!=const.N-1):
   print("east_in"+str(i+1)+"<="+"east_out"+str(i)+";")
   print("west_in"+str(i-1)+"<="+"west_out"+str(i)+";")
