...
for i in range(const.N):
 for j in range(const.N):
  ...
  if(i==0 and j==const.N-1):
    ...
    print(".i04"+"("+"south_in"+str(i)+str(j)+")"+","+".o00"+"("+"local_out"+str(i)+str(j)+")"+","+".o01"+"("+")"+","+".o02"+"("+"west_out"+str(i)+str(j)+")"+","+".o03"+"("+")"+","+".o04"+"("+"south_out"+str(i)+str(j)+")"+","+".Write(Write)"+","+".Read(Read)"+');')
  if(i==const.N-1 and j==0):
    print("router r_$"+ str(i)+str(j)+'( .clk(clk), .rst(reset),'+".i00"+"("+"local_in"+str(i)+str(j)+")"+","+".i01"+"("+"east_in"+str(i)+str(j)+")"+","+".i02"+"("+")"+",")
    print(".i03"+"("+"north_in"+str(i)+str(j)+")"+","+".i04"+"("+")"+","+".o00"+"("+"local_out"+str(i)+str(j)+")"+","+".o01"+"("+"east_out"+str(i)+str(j)+")"+","+".o02"+"("+")"+","+".o03"+"("+"north_out"+str(i)+str(j)+")"+","+".o04"+"("+")"+","+".Write(Write)"+","+".Read(Read)"+');')
  if(i==const.N-1 and j==const.N-1):
    print("router r_$"+ str(i)+str(j)+'( .clk(clk), .rst(reset),'+".i00"+"("+"local_in"+str(i)+str(j)+")"+","+".i01"+"("+")"+","+".i02"+"("+"west_in"+str(i)+str(j)+")"+",")
    print(".i03"+"("+"north_in"+str(i)+str(j)+")"+","+".i04"+"("+")"+","+".o00"+"("+"local_out"+str(i)+str(j)+")"+","+".o01"+"("+")"+","+".o02"+"("+"west_out"+str(i)+str(j)+")"+","+".o03"+"("+"north_out"+str(i)+str(j)+")"+","+".o04"+"("+")"+","+".Write(Write)"+","+".Read(Read)"+');')
  if(j==0 and i!=0 and i!=const.N-1):
    print("router r_$"+ str(i)+str(j)+'( .clk(clk), .rst(reset),'+".i00"+"("+"local_in"+str(i)+str(j)+")"+","+".i01"+"("+"east_in"+str(i)+str(j)+")"+","+".i02"+"("+")"+"," )   
    print(".i03"+"("+"north_in"+str(i)+str(j)+")"+","+".i04"+"("+"south_in"+str(i)+str(j)+")"+","+".o00"+"("+"local_out"+str(i)+str(j)+")"+","+".o01"+"("+"east_out"+str(i)+str(j)+")"+","+".o02"+"("+")"+","+".o03"+"("+"north_out"+str(i)+str(j)+")"+","+".o04"+"("+"south_out"+str(i)+str(j)+")"+","+".Write(Write)"+","+".Read(Read)"+');')
  if(j==const.N-1 and i!=0 and i!=const.N-1):
    print("router r_$"+ str(i)+str(j)+'( .clk(clk), .rst(reset),'+".i00"+"("+"local_in"+str(i)+str(j)+")"+","+".i01"+"("+")"+","+".i02"+"("+"west_in"+str(i)+str(j)+")"+",")
  ...
  if(i==0 and j!=0 and j!=const.N-1):
    print("router r_$"+ str(i)+str(j)+'( .clk(clk), .rst(reset),'+".i00"+"("+"local_in"+str(i)+str(j)+")"+","+".i01"+"("+"east_in"+str(i)+str(j)+")"+","+".i02"+"("+"west_in"+str(i)+str(j)+")"+","+".i03"+"("+")"+","+".i04"+"("+"south_in"+str(i)+str(j)+")"+","+".o00"+"("+"local_out"+str(i)+str(j)+")"+","+".o01"+"("+"east_out"+str(i)+str(j)+")"+","+".o02"+"("+"west_out"+str(i)+str(j)+")"+","+".o03"+"("+")"+","+".o04"+"("+"south_out"+str(i)+str(j)+")"+","+".Write(Write)"+","+".Read(Read)"+');')
  if(i==const.N-1 and j!=0 and j!=const.N-1):
    print("router r_$"+ str(i)+str(j)+'( .clk(clk), .rst(reset),'+".i00"+"("+"local_in"+str(i)+str(j)+")"+","+".i01"+"("+"east_in"+str(i)+str(j)+")"+","+".i02"+"("+"west_in"+str(i)+str(j)+")"+","+".i03"+"("+"north_in"+str(i)+str(j)+")"+","+".i04"+"("+")"+","+".o00"+"("+"local_out"+str(i)+str(j)+")"+","+".o01"+"("+"east_out"+str(i)+str(j)+")"+","+".o02"+"("+"west_out"+str(i)+str(j)+")"+","+".o03"+"("+"north_out"+str(i)+str(j)+")"+","+".o04"+"("+")"+","+".Write(Write)"+","+".Read(Read)"+');')
  if(i!=0 and i!=const.N-1 and j!=0 and j!=const.N-1):
    print("router r_$"+ str(i)+str(j)+'( .clk(clk), .rst(reset),'+".i00"+"("+"local_in"+str(i)+str(j)+")"+","+".i01"+"("+"east_in"+str(i)+str(j)+")"+","+".i02"+"("+"west_in"+str(i)+str(j)+")"+","+".i03"+"("+"north_in"+str(i)+str(j)+")"+","+".i04"+"("+"south_in"+str(i)+str(j)+")"+","+".o00"+"("+"local_out"+str(i)+str(j)+")"+","+".o01"+"("+"east_out"+str(i)+str(j)+")"+","+".o02"+"("+"west_out"+str(i)+str(j)+")"+","+".o03"+"("+"north_out"+str(i)+str(j)+")"+","+".o04"+"("+"south_out"+str(i)+str(j)+")"+","+".Write(Write)"+","+".Read(Read)"+');')
