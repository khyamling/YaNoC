...
for i in range(N):
 for j in range(N):
  if(i==0 and j==0):
    print("router r_$"+ str(i)+str(j) + '( .clk(clk), .rst(reset),'+".i00"+"(local"+str(i)+"_in"+str(i)+str(j)+")"+","+".i01"+"(east"+str(i)+"_in"+str(i)+str(j)+")"+","+".i02"+"("+")"+",")
    print(".i03"+"("+")"+","+".i04"+"(south"+str(i)+"_in"+str(i)+str(j)+")"+","+".o00"+"(local"+str(i)+"_out"+str(i)+str(j)+")"+","+".o01"+"(east"+str(i)+"_out"+str(i)+str(j)+")"+",")
    print(".o02"+"("+")"+","+".o03"+"("+")"+","+".o04"+"(south"+str(i)+"_out"+str(i)+str(j)+")"+","+".Write(Write)"+","+".Read(Read)"+');')
  if(i==0 and j==N-1):
    print("router r_$"+ str(i)+str(j)+'( .clk(clk), .rst(reset),'+".i00"+"(local"+str(i)+"_in"+str(i)+str(j)+")"+","+".i01"+"("+")"+","+".i02"+"(west"+str(i)+"_in"+str(i)+str(j)+")"+","+".i03"+"("+")"+",")
    print(".i04"+"(south"+str(i)+"_in"+str(i)+str(j)+")"+","+".o00"+"(local"+str(i)+"_out"+str(i)+str(j)+")"+","+".o01"+"("+")"+","+".o02"+"(west"+str(i)+"_out"+str(i)+str(j)+")"+","+".o03"+"("+")"+",")
    print(".o04"+"(south"+str(i)+"_out"+str(i)+str(j)+")"+","+".Write(Write)"+","+".Read(Read)")
    print(');')
  if(i==N-1 and j==0):
    print("router r_$"+ str(i)+str(j)+'( .clk(clk), .rst(reset),'+".i00"+"(local"+str(i)+"_in"+str(i)+str(j)+")"+","+".i01"+"(east"+str(i)+"_in"+str(i)+str(j)+")"+","+".i02"+"("+")"+",")
    print(".i03"+"(north"+str(i)+"_in"+str(i)+str(j)+")"+","+".i04"+"("+")"+","+".o00"+"(local"+str(i)+"_out"+str(i)+str(j)+")"+","+".o01"+"(east"+str(i)+"_out"+str(i)+str(j)+")"+","+".o02"+"("+")"+",")
    print(".o03"+"(north"+str(i)+"_out"+str(i)+str(j)+")"+","+".o04"+"("+")"+","+".Write(Write)"+","+".Read(Read)"+');')
  if(i==N-1 and j==N-1):
    print("router r_$"+ str(i)+str(j)+'( .clk(clk), .rst(reset),'+".i00"+"(local"+str(i)+"_in"+str(i)+str(j)+")"+","+".i01"+"("+")"+","+".i02"+"(west"+str(i)+"_in"+str(i)+str(j)+")"+",")
    print(".i03"+"(north"+str(i)+"_in"+str(i)+str(j)+")"+","+".i04"+"("+")"+","+".o00"+"(local"+str(i)+"_out"+str(i)+str(j)+")"+","+".o01"+"("+")"+","+".o02"+"(west"+str(i)+"_out"+str(i)+str(j)+")"+",")
    print(".o03"+"(north"+str(i)+"_out"+str(i)+str(j)+")"+","+".o04"+"("+")"+","+".Write(Write)"+","+".Read(Read)"+');')
  if(j==0 and i!=0 and i!=N-1):
    print("router r_$"+ str(i)+str(j)+'( .clk(clk), .rst(reset),'+".i00"+"(local"+str(i)+"_in"+str(i)+str(j)+")"+","+".i01"+"(east"+str(i)+"_in"+str(i)+str(j)+")"+","+".i02"+"("+")"+"," )   
    print(".i03"+"(north"+str(i)+"_in"+str(i)+str(j)+")"+","+".i04"+"(south"+str(i)+"_in"+str(i)+str(j)+")"+","+".o00"+"(local"+str(i)+"_out"+str(i)+str(j)+")"+","+".o01"+"(east"+str(i)+"_out"+str(i)+str(j)+")"+",")
    print(".o02"+"("+")"+","+".o03"+"(north"+str(i)+"_out"+str(i)+str(j)+")"+","+".o04"+"(south"+str(i)+"_out"+str(i)+str(j)+")"+","+".Write(Write)"+","+".Read(Read)"+');')
  if(j==N-1 and i!=0 and i!=N-1):
    print("router r_$"+ str(i)+str(j)+'( .clk(clk), .rst(reset),'+".i00"+"(local"+str(i)+"_in"+str(i)+str(j)+")"+","+".i01"+"("+")"+","+".i02"+"(west"+str(i)+"_in"+str(i)+str(j)+")"+",")
    print(".i03"+"(north"+str(i)+"_in"+str(i)+str(j)+")"+","+".i04"+"(south"+str(i)+"_in"+str(i)+str(j)+")"+","+".o00"+"(local"+str(i)+"_out"+str(i)+str(j)+")"+","+".o01"+"("+")"+",")
    print(".o02"+"(west"+str(i)+"_out"+str(i)+str(j)+")"+","+".o03"+"(north"+str(i)+"_out"+str(i)+str(j)+")"+","+".o04"+"(south"+str(i)+"_out"+str(i)+str(j)+")"+","+".Write(Write)"+","+".Read(Read)"+');')
  if(i==0 and j!=0 and j!=N-1):
    print("router r_$"+ str(i)+str(j)+'( .clk(clk), .rst(reset),'+".i00"+"(local"+str(i)+"_in"+str(i)+str(j)+")"+","+".i01"+"(east"+str(i)+"_in"+str(i)+str(j)+")"+","+".i02"+"(west"+str(i)+"_in"+str(i)+str(j)+")"+",")
    print(".i03"+"("+")"+","+".i04"+"(south"+str(i)+"_in"+str(i)+str(j)+")"+","+".o00"+"(local"+str(i)+"_out"+str(i)+str(j)+")"+","+".o01"+"(east"+str(i)+"_out"+str(i)+str(j)+")"+",")
    print(".o02"+"(west"+str(i)+"_out"+str(i)+str(j)+")"+","+".o03"+"("+")"+","+".o04"+"(south"+str(i)+"_out"+str(i)+str(j)+")"+","+".Write(Write)"+","+".Read(Read)"+');')
  if(i==N-1 and j!=0 and j!=N-1):
    print("router r_$"+ str(i)+str(j)+'( .clk(clk), .rst(reset),'+".i00"+"(local"+str(i)+"_in"+str(i)+str(j)+")"+","+".i01"+"(east"+str(i)+"_in"+str(i)+str(j)+")"+","+".i02"+"(west"+str(i)+"_in"+str(i)+str(j)+")"+",")
    print(".i03"+"(north"+str(i)+"_in"+str(i)+str(j)+")"+","+".i04"+"("+")"+","+".o00"+"(local"+str(i)+"_out"+str(i)+str(j)+")"+","+".o01"+"(east"+str(i)+"_out"+str(i)+str(j)+")"+",")
    print(".o02"+"(west"+str(i)+"_out"+str(i)+str(j)+")"+","+".o03"+"(north"+str(i)+"_out"+str(i)+str(j)+")"+","+".o04"+"("+")"+","+".Write(Write)"+","+".Read(Read)"+');')
  if(i!=0 and i!=N-1 and j!=0 and j!=N-1):
    print("router r_$"+ str(i)+str(j)+'( .clk(clk), .rst(reset),'+".i00"+"(local"+str(i)+"_in"+str(i)+str(j)+")"+","+".i01"+"(east"+str(i)+"_in"+str(i)+str(j)+")"+","+".i02"+"(west"+str(i)+"_in"+str(i)+str(j)+")"+",")
    print(".i03"+"(north"+str(i)+"_in"+str(i)+str(j)+")"+","+".i04"+"(south"+str(i)+"_in"+str(i)+str(j)+")"+","+".o00"+"(local"+str(i)+"_out"+str(i)+str(j)+")"+","+".o01"+"(east"+str(i)+"_out"+str(i)+str(j)+")"+",")
    print(".o02"+"(west"+str(i)+"_out"+str(i)+str(j)+")"+","+".o03"+"(north"+str(i)+"_out"+str(i)+str(j)+")"+","+".o04"+"(south"+str(i)+"_out"+str(i)+str(j)+")"+","+".Write(Write)"+","+".Read(Read)"+');')
